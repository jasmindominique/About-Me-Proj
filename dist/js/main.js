...
console.log("Today we're making an About Me Page!"); // Javascript story - 
...
console.log($images);
var $currentImage = 0; //this starts the slideshow at 0 (1st image)
...
function imageCounter() {
  ...
  if ($currentImage >= $images.length) {
    // if the counter is greater than or equal the image length then....
...
console.log($currentImage); //Create a slideshow out of Jasmin Images then add animation on a timeline with each image
// depending on the 
